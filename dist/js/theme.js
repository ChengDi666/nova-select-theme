...
function selectTitleBorder(event) {
    ...
    if (!event) return;
    var titleEvent = '';
    if (event.nodeName == 'H3') {
        // 点击 h3
        titleEvent = event;
    } else if (event.nodeName == 'P') {
        // 点击 p
...
window.onload = function () {
    ...
    hamburger.addEventListener("click", function (e) {
        ...
        e.stopPropagation();
        var leftPx = content.style.marginLeft;
        leftPx = leftPx == '220px' ? '0' : '220px';
        var rightPx = leftPx == '0' ? '3.125rem' : '240px';
...
/* scopeId */
var __vue_scopeId__ = "data-v-d49d3374"
...
Component.options.__file = "resources/js/components/NovaSelectTheme.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d49d3374", Component.options)
  } else {
    hotAPI.reload("data-v-d49d3374", Component.options)
  }
...
var update = __webpack_require__(6)("f5e4182c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d49d3374\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./NovaSelectTheme.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d49d3374\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./NovaSelectTheme.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            mytypes: '',
            allThemes: [{ type: 'blue', name: '蓝色' }, { type: 'new', name: '最新' }]
        };
    },

    created: function created() {},
    mounted: function mounted() {
        var themes = localStorage.themesname === undefined ? 'blue' : localStorage.themesname;
    ...
    methods: {
        selectOne: function selectOne(mytype) {
            document.querySelectorAll('.w-sidebar h3').forEach(function (item) {
        ...
        toggleTheme: function toggleTheme(type) {
            this.allThemes.map(function (item) {
                if (type === item.type) {
...
var render = function() {
  ...
  return _c("div", [
    _c("p", { staticClass: "theme-title" }, [_vm._v("选择主题：")]),
    _vm._v(" "),
    _c(
      "ul",
      { staticClass: "list-reset theme-lists" },
      _vm._l(_vm.allThemes, function(item, index) {
        return _c(
          "li",
          {
            key: index,
            class: { "theme-bgblue": _vm.mytypes === item.type },
            on: {
              click: function($event) {
                return _vm.selectOne(item.type)
              }
            }
          },
          [_vm._v("\n            " + _vm._s(item.name) + "\n        ")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-d49d3374", module.exports)
  }
}
